...
import chapter3.exercises.foldLeft
import chapter3.exercises.foldLeftR
import chapter3.solutions.flatMap
...
fun <A> sequence(xs: List<Option<A>>): Option<List<A>> =
    foldRight(xs, Some(List.empty())){x, acc -> map2(x, acc){ a, b -> Cons(a, b) } }
//end::init[]
